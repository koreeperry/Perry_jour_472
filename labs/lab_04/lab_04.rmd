...
```{r}
md_church_payments <- read.csv("data/church_payments.csv")
```
...
**A5: Some questions I have would include...are these payments being fully used for what they are described to be used for (whatever the description states, according to the code or whatever "Vendor Payment" means).**
