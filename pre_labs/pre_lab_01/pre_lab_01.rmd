...
**Answer is 7314 obs. of 29 variables! - KP** 
...
In the space below, write the name of the church from the first row of the "name" column. **Answer is HEALING AND DELIVERANCE MINISTRY INC - KP**
...
**Answer is to basically look at the dataset, and then sort each church in the city and then show how many there are. - KP**
...
Compared to the previous codeblock, what has changed and how did that affect the result? **Answer is: It does the same thing BUT the addition is that it sorts it in descending order according to which city has the most churches.**
...
**Answer is: It shows the cluster of where churches are by their zip codes. - KP**
...
Compared to the previous codeblock, what has changed and how did that affect the result? What do the top terms have in common? **Answer: from the previous codeblock, it shows the names of the megachurhes. In this codeblock, it shows the denomination as well as how many people are apart of megachurches in this denomination. - KP**
...
1.  Which churches are on the same street?

2.  Churches in order from smallest to largest.

3.  How many people left the church?? (unsure about this one)
