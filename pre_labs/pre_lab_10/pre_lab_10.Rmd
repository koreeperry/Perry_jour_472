...
**Task** Run the following code. Describe the output in the space below. **Answer - It shoes specifics like the different state and county fips, longitutde and latitutde, and a bunch of other things that I don't really know. I'm not sure about the columns like LSAD or CBSAFP, I'm not sure what those all stand for.**
