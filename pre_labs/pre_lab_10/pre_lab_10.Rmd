...
**Task** Run the following code. Describe the output in the space below. **Answer - The following code pulls data from the 2017-2025 period from the Census website. Data for MD counties (for population) and the longitude and latitutde in each coutny in the state of Maryland.**
